...
@WebServlet(name = "searchRoomsByFieldsByPageFacade",urlPatterns = "/facade/searchRoomsByFieldsByPageFacade")
public class SearchRoomsByFieldsByPageFacade extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		try {
			...
			String roomName = StringUtil.isBlank(request.getParameter("roomName"))?null:request.getParameter("roomName");
			String roomNo = StringUtil.isBlank(request.getParameter("roomNo"))?null:request.getParameter("roomNo");
			...
			Long recordCount = service.countSearchRoomsByFieldsRecords(room);
			...
			List<Room> list = service.searchRoomsByFieldsByPage(room,pagenum,pagesize);
