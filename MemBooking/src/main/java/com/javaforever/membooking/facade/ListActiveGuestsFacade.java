...
@WebServlet(name = "listActiveGuestsFacade",urlPatterns = "/facade/listActiveGuestsFacade")
public class ListActiveGuestsFacade extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		try {
			...
			List<Guest> list = service.listActiveGuests();
