...
@WebServlet(name = "deleteGuestFacade",urlPatterns = "/facade/deleteGuestFacade")
public class DeleteGuestFacade extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		try {
			...
			boolean success = service.deleteGuest(id);
