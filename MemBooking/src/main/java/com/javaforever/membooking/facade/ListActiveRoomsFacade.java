...
@WebServlet(name = "listActiveRoomsFacade",urlPatterns = "/facade/listActiveRoomsFacade")
public class ListActiveRoomsFacade extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		try {
			...
			List<Room> list = service.listActiveRooms();
